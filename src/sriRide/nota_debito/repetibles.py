...
def construir_pago_contexto(nota_debito_root: etree._Element) -> dict:
    forma_pago_map = {
    ...
    pago_nodes = walk_path_nodes(nota_debito_root, "notaDebito.infoNotaDebito.pagos.pago")
    formas: list[dict] = []
...
def construir_info_adicional_contexto(nota_debito_root: etree._Element) -> dict:
    campo_nodes = walk_path_nodes(nota_debito_root, "notaDebito.infoAdicional.campoAdicional")
    campos: list[dict] = []
