...
def construir_totales_contexto(nota_debito_root: etree._Element) -> dict:
    impuestos = walk_path_nodes(nota_debito_root, "notaDebito.infoNotaDebito.impuestos.impuesto")
    ...
    subtotal_objeto_exento = _sum_impuesto_field(
        impuestos, codigo="2", codigo_porcentaje_in={"6", "7"}, field="baseImponible"
    )
    ...
    return {
        ...
        "subtotal_general": first_text(nota_debito_root, "notaDebito.infoNotaDebito.totalSinImpuestos"),
        ...
        "total": first_text(nota_debito_root, "notaDebito.infoNotaDebito.valorTotal"),
    }
