...
def construir_info_adicional_contexto(retencion_root: etree._Element) -> dict:
    campo_nodes = walk_path_nodes(retencion_root, "comprobanteRetencion.infoAdicional.campoAdicional")
    campos: list[dict] = []
