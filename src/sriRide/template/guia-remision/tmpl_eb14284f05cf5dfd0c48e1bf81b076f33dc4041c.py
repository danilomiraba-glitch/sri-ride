...
def root(context, missing=missing):
    ...
    l_0_transportista = resolve('transportista')
    l_0_destinatario = resolve('destinatario')
    ...
    yield '</h1>\n        <span class="tipo-doc">Guía de Remisión</span>\n        <span class="ambiente-badge">N° '
    ...
    yield '</td></tr>\n      </table>\n    </div>\n    <div class="parte">\n      <span class="parte-label">Transportista</span>\n      <table>\n        <tr><td>Identificación (Transportista)</td><td>'
    yield escape(environment.getattr((undefined(name='transportista') if l_0_transportista is missing else l_0_transportista), 'identificacion'))
    yield '</td></tr>\n        <tr><td>Razón Social/Nombre</td><td>'
    yield escape(environment.getattr((undefined(name='transportista') if l_0_transportista is missing else l_0_transportista), 'razon_social'))
    yield '</td></tr>\n        <tr><td>Placa</td><td>'
    yield escape(environment.getattr((undefined(name='transportista') if l_0_transportista is missing else l_0_transportista), 'placa'))
    yield '</td></tr>\n        <tr><td>Punto de Partida</td><td>'
    yield escape(environment.getattr((undefined(name='transportista') if l_0_transportista is missing else l_0_transportista), 'direccion'))
    yield '</td></tr>\n        <tr><td>Fecha Inicio Transporte</td><td>'
    yield escape(environment.getattr((undefined(name='transportista') if l_0_transportista is missing else l_0_transportista), 'fecha_inicio'))
    yield '</td></tr>\n        <tr><td>Fecha Fin Transporte</td><td>'
    yield escape(environment.getattr((undefined(name='transportista') if l_0_transportista is missing else l_0_transportista), 'fecha_fin'))
    yield '</td></tr>\n      </table>\n    </div>\n  </div>\n    <div class="seccion-header">\n      <h2>Destinatarios</h2>\n    </div>\n    '
    for l_1_item in environment.getitem((undefined(name='destinatario') if l_0_destinatario is missing else l_0_destinatario), 'items'):
        _loop_vars = {}
        pass
        yield '\n    <div data-tpl-repeat="destinatario.items">\n      <div class="anexo-seccion-header">\n       <div class="anx-info">\n        <div class="anx-titulo">Destinatario</div>\n       </div>\n      </div>\n      <div class="anx-referencia-banda">\n      <div class="anx-ref-item">\n        <span class="anx-ref-label">Comprobante de Venta</span>\n        <span class="anx-ref-value">'
        yield escape(environment.getattr(l_1_item, 'tipo_documento'))
        yield ' N° '
        yield escape(environment.getattr(l_1_item, 'numero_documento'))
        ...
        yield '</span>\n      </div>\n    </div>\n    <div class="guia-grid">\n      <div class="guia-item">\n        <div class="guia-label">Motivo Traslado</div>\n        <div class="guia-value">'
        yield escape(environment.getattr(l_1_item, 'motivo_traslado'))
        yield '</div>\n      </div>\n      <div class="guia-item">\n        <div class="guia-label">Destino (Punto de Llegada)</div>\n        <div class="guia-value">'
        yield escape(environment.getattr(l_1_item, 'destino'))
        yield '</div>\n      </div>\n      <div class="guia-item">\n        <div class="guia-label">Identificación (Destinatario)</div>\n        <div class="guia-value">'
        yield escape(environment.getattr(l_1_item, 'identificacion'))
        yield '</div>\n      </div>\n      <div class="guia-item">\n        <div class="guia-label">Razon Social/Nombre y Apellido</div>\n        <div class="guia-value">'
        yield escape(environment.getattr(l_1_item, 'razon_social'))
        yield '</div>\n      </div>\n      <div class="guia-item">\n        <div class="guia-label">Documento Aduanero</div>\n        <div class="guia-value">'
        yield escape((environment.getattr(l_1_item, 'documento_aduanero') or '---'))
        yield '</div>\n      </div>\n      <div class="guia-item">\n        <div class="guia-label">Código Establecimiento Destino</div>\n        <div class="guia-value">'
        yield escape((environment.getattr(l_1_item, 'cod_establecimiento_destino') or ''))
        yield '</div>\n      </div>\n      <div class="guia-item">\n        <div class="guia-label">Ruta</div>\n        <div class="guia-value">'
        yield escape(environment.getattr(l_1_item, 'ruta'))
        yield '</div>\n      </div>\n    </div>\n    <div class="anx-subseccion">\n      <div class="anx-subseccion-header">Detalle Productos</div>\n      <div class="guia-destinos">\n        <table class="t-destinos">\n          <thead>\n            <tr>\n              <th>Cantidad</th>\n              <th>Descripción</th>\n              <th>Código</th>\n              <th>Código Secundario</th>\n              <th>Detalle Adicional</th>\n            </tr>\n          </thead>\n          <tbody>\n            '
        t_1 = 1
        for l_2_det in environment.getattr(l_1_item, 'detalles'):
            _loop_vars = {}
            pass
            yield '\n              <tr>\n                <td class="c">'
            yield escape(environment.getattr(l_2_det, 'cantidad'))
            yield '</td>\n                <td>'
            yield escape(environment.getattr(l_2_det, 'descripcion'))
            yield '</td>\n                <td>'
            yield escape(environment.getattr(l_2_det, 'codigo'))
            yield '</td>\n                <td class="c">'
            yield escape((environment.getattr(l_2_det, 'codigo_secundario') or ''))
            yield '</td>\n                <td>'
            yield escape((environment.getattr(l_2_det, 'detalle_adicional') or ''))
            yield '</td>\n              </tr>\n            '
            t_1 = 0
        l_2_det = missing
        if t_1:
...
blocks = {}
debug_info = '7=18&8=21&16=27&18=29&23=31&27=33&31=35&38=39&42=41&43=44&45=47&46=50&53=53&55=55&56=57&57=59&58=61&59=63&65=65&66=67&67=69&68=71&69=73&70=75&77=77&87=81&91=85&95=87&101=89&105=91&109=93&113=95&117=97&121=99&125=101&142=104&144=108&145=110&146=112&147=114&148=116&168=126&170=130'